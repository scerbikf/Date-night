...
class DateNightApp {
    ...
    saveToLocalStorage() {
        try {
            ...
            localStorage.setItem('dateNightCurrentSelections', JSON.stringify(data));
    ...
    finishSelection() {
        ...
        // Save final data to localStorage history
    ...
    // Save final data to localStorage history
    saveDataToHistory() {
        console.log('💾 Saving final data to localStorage...');
        ...
        try {
            ...
            console.log('✅ Final data saved to localStorage');
